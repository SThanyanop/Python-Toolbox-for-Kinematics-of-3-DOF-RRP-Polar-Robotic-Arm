...
3. [Workspace Function](#workspace-function)
...
Generates and displays the 3D workspace visualization showing all reachable end-effector positions.
...
- **Boundary Faces**: Show actual reachable surface
...
```python
# Use fewer samples for faster preview (default is (10,10,5))
toolbox.plot_workspace_3d()
```
...
3. **Use elevation/azimuth sliders** for precise rotation 
